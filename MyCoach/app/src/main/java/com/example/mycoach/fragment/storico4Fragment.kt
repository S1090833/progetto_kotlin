...
class storico4Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = Esercizi4Adapter(eserciziList)
