...
class Giorni2Adapter(
    private val listGiorni: ArrayList<GiorniDataClass>
) : RecyclerView.Adapter<Giorni2Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val storico3Fragment = storico2Fragment().apply {
            ...
            fragmentActivity.supportFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, storico3Fragment)
                .addToBackStack(null)
                .commit()
        }
    }
