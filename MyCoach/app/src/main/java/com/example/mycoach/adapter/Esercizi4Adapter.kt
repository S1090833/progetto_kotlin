...
class Esercizi4Adapter(
    private val eserciziList: ArrayList<eserciziDataclass>
) : RecyclerView.Adapter<Esercizi4Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val dettaglio2Fragment = Dettaglio2Fragment().apply {
            ...
            fragmentActivity.supportFragmentManager.beginTransaction()
                .replace(R.id.fragment_container,dettaglio2Fragment)
                .addToBackStack(null)
                .commit()
        }
    }
